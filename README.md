<div align="center">
  <h1>🤖 Telegram Multi‑Functional Bot</h1>
...
<div align="center">
  ...
  <p><i>Пример отображения inline‑клавиатуры и основного меню</i></p>
</div>

> **Примечание:** Замените ссылку выше на реальный скриншот вашего бота. Вы можете загрузить изображение в репозиторий и указать путь, например: `assets/screenshot.png`.

---

## 🔌 Используемые API

### 1. **Kinopoisk API (unofficial)**
